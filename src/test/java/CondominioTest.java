...
public class CondominioTest
{
	...
	*/
	...
	{
		Casa newCasa = new Casa("CasaTestPost", "127.0.0.1", 8080, 8081);
		...
		// aggiunge altra casa
		// POST /condominio/add: inserisce nuova casa
		Casa newCasa2 = new Casa("CasaTestPost2", "127.0.0.1", 8080, 8081);
		url = new URL(URL + "/condominio/add");
		conn = (HttpURLConnection) url.openConnection();
		conn.setRequestMethod("POST");
		conn.setRequestProperty("content-type", "application/xml");
	...
	{
		Casa newCasa = new Casa("CasaConflictTest", "127.0.0.1", 8080, 8081);
